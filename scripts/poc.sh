...
tests_poc() {
    ...
    # test nvme
    "${grpc_cli[@]}" call --json_input --json_output opi-spdk-server:50051 NVMeNamespaceCreate "{'namespace' : { 'spec' : {'id' : {'value' : 'namespace1'}, 'subsystem_id' : { 'value' : 'nqn.2016-06.io.spdk:cnode1' }, 'volume_id' : { 'value' : 'Malloc1' }, 'host_nsid' : '1' } } }"
